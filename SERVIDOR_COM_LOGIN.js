// SERVIDOR CRM PMG COM SISTEMA DE LOGIN
// Execute: node SERVIDOR_COM_LOGIN.js

const express = require('express');
const path = require('path');
const crypto = require('crypto');

console.log('🚀 Iniciando Servidor CRM PMG com Sistema de Login...');
...
<body>
    ...
    <script>
        ...
        // Auto-preencher com credenciais de teste
        document.getElementById('email').addEventListener('dblclick', function() {
            this.value = 'admin@crmpmg.com';
...
app.listen(PORT, '0.0.0.0', () => {
    console.log('');
    console.log('🎉 CRM PMG COM LOGIN ESTÁ ONLINE!');
    console.log('');
    ...
    console.log('');
    console.log('✅ Sistema com autenticação funcional!');
