...
# 🗄️ CÓDIGO SQL PARA SUPABASE

Copie e cole todo este código no **SQL Editor** do seu projeto Supabase:

```sql
-- ========================================
-- CRM PMG - Estrutura Completa do Banco
-- ========================================
...
-- Tabela de Itens de Negócio (Deal Items)
...
-- Políticas para clientes (todos usuários autenticados podem ver)
...
- **Admin:** `admin@crmpmg.com` / `Admin@2024!`
- **Teste:** `usuario@crmpmg.com` / `Usuario@2024!`

## 3. **Dados Incluídos:**
- ✅ 4 usuários (admin, vendedores)
...
- 📊 Views de métricas e dashboard
- 🔒 Row Level Security (RLS)
- 📈 Funções de análise
- 💾 Triggers automáticos
- 📋 Dados de exemplo completos

**Execute o SQL no Supabase e seu CRM estará 100% funcional!** 🚀
